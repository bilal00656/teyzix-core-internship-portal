...
if($_SERVER['REQUEST_METHOD']==='POST'){
  ...
  if($res){
    ...
    if($ok){ $_SESSION['admin_id']=$res['id']; $_SESSION['admin_user']=$u; header('Location: dashboard.php'); exit; }
  }
...
<div class="login-wrap">
  <div class="glass login-card">
    ...
    <p class="text-center mt-3 mb-0" style="color:var(--muted);font-size:.85rem">Default: <code>admin</code> / <code>admin123</code></p>
